...
export function AchievementCarousel() {
  ...
  return (
    <div className="relative md:min-h-screen bg-gray-900 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20">
        ...
        >
          Past <span className="text-orange-500">Achievement</span>
        </motion.h2>
        ...
        <div className="relative h-[400px] md:h-[500px] flex items-center justify-center mb-16">
          ...
          <Button
            onClick={() => paginate(-1)}
            className="absolute left-4 md:left-8 z-20 bg-orange-500 hover:bg-orange-600 rounded-full p-2"
            size="icon"
            variant="ghost"
          >
          ...
          <Button
            onClick={() => paginate(1)}
            className="absolute right-4 md:right-8 z-20 bg-orange-500 hover:bg-orange-600 rounded-full p-2"
            size="icon"
            variant="ghost"
          >
          ...
          {/* Dots */}
          <div className="absolute -bottom-[20%] left-0 right-0 flex justify-center gap-3 pb-4">
            {achievements.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-colors duration-300 ${index === currentIndex ? 'bg-orange-500 scale-125' : 'bg-gray-600 hover:bg-gray-500'
                  }`}
